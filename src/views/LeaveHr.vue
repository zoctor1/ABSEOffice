    ...
    <!-- {{window}} -->
      ...
      <div id="rowTable">
        <b-row>
          ...
          <b-col lg="2" style="padding-top:24px; text-align:right;">
            <vs-button
      ...
      <div id="rowTable">
        <b-row> 
          ...
          <b-col md="12" lg="1" style="padding-top:24px;">
            <b-button
              variant="outline-primary"
              @click="filterData()"
              style="height:42px; width:126px; margin:0px 10px 10px 0px; "
            >
              ค้นหา
            </b-button>
          </b-col>
          <b-col md="12" lg="1" style="padding-top:24px;">
            <b-button
              ...
              @click="defaultValue()"
              style="height:42px; width:126px; margin:0px 0px 10px 0px; " 
            >
              เคลียร์ข้อมูล
            </b-button>
          </b-col>
