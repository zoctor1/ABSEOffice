<template>
  <div id="popupLeaveEdit">
    ...
    <modal name="hello-world"
      id="sizepopupLeaveEdit"
      height="auto"
      :clickToClose="false"
      :active.sync="popupLeaveEdit"
    >
              ...
              <b-row>
                <b-col>
                  ...
                  <div class="form-group" :class="{ 'form-group--error': $v.form.valDate1.$error }">
                    <datetime v-if="popupLeaveEdit" type="date" v-model.trim="$v.form.valDate1.$model" format="dd/MM/yyyy" :min-datetime="currentDate" style="border: 1px solid rgba(0,0,0,.2); border-radius: 4px;"></datetime>
                ...
                <b-col>
                  ...
                  <div class="form-group" :class="{ 'form-group--error': $v.form.valDate2.$error }">
                    <datetime v-if="popupLeaveEdit" type="date" v-model.trim="$v.form.valDate2.$model" format="dd/MM/yyyy" :min-datetime="$v.form.valDate1.$model !='' ? $v.form.valDate1.$model : currentDate" style="border: 1px solid rgba(0,0,0,.2); border-radius: 4px;"></datetime>
...
<style>
  ...
  #sizepopupLeaveEdit .vs-popup {
    /* position: relative; */
    /* z-index: 1; */
    width: 30% !important;
    /* height: 65% !important; */
  }
  #sizepopupLeaveEdit .vs-popup--content {
    overflow: hidden !important;
    z-index: 1;
  }
  #sizepopupLeaveEdit .vhd-input {
    margin-top: 10px;
    margin-bottom: 10px;
    cursor: pointer;
  }
  #sizepopupLeaveEdit .vhd-picker {
    position: absolute;
    z-index: 2;
  }
  #sizepopupLeaveEdit  .field-input {
    width: 130px !important;
    height: 37px !important;
    font-size: 16px !important;
    padding: none;
  }
  #sizepopupLeaveEdit .vdatetime-input {
    width: 235px !important;
    height: 40px !important;
    font-size: 16px !important;
    border: none;
  }
  #sizepopupLeaveEdit .fs-16 {
    display: none;
  }
  /* #sizepopupLeaveEdit .before {
    display: none;
  } */
  #sizepopupLeaveEdit .custom-select {
    border: none;
  }
</style>